<template>
    <div class="card" v-if="isShow">
        <el-card class="card">
            ...
            <div class="classify">
                <div class="aircraft">
                    <div style="color: aliceblue;font-weight: 600;font-size: 20px; margin:0 auto ;">战斗机:数量3</div>
                ...
                <div class="ship">
                    <div style="color: aliceblue;font-weight: 600;font-size: 20px; margin:0 auto ;">舰船:数量3</div>
    ...
    series: [
        {
            ...
            center: ['50%', '50%'],
            data: [
                { value: 335, name: 'F-22A猛禽战斗机' },
                { value: 310, name: 'F-35A闪电II战斗机' },
                { value: 274, name: 'F/A-18E/F超级大黄蜂战斗机' },
                { value: 235, name: '视频广告' },
                { value: 400, name: '搜索引擎' }
...
watch(() => props.countryName, (newV) => {
    if (newV === '中国') {
        ...
        // airOpt.value = optionCN_air
        // airOpt.value = option2
